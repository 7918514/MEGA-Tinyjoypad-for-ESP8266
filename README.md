...
В устройстве есть возможность измерять напряжение на аккумуляторе посредством пина ADC контроллера ESP8266. Для этого используется делитель напряжения R3 и R4.  
...
Вибромотор и аккумулятор нельзя мыть в воде, поэтому они монтируются в последнюю очередь с применением припоя с канифолью или при помощи неактивного (NO CLEAN) флюса.  
...
В качестве толкателей для кнопок мною были использованы деревянные палочки для маникюра, отрезанные и подточенные под необходимый размер. Толкатели для джойстика были изготовлены из стержней пластиковых вытяжных заклепок. Используйте любые подручные материалы.  
  
![Толкатель](pics/pusher.jpg) 
...
Если вы после сборки сразу хотите загрузить прошивку, не разбираясь с Arduino IDE, то делайте описанное ниже.  
Загрузите в устройство готовую прошивку **MEGAcompilation160mhz_v0026.bin** программой Flash Download Tool.  
Смотрите скриншот настроек программы.  
![Скриншот](pics/FlashDownloadTool.jpg)  
  
Скачать программу Flash Download Tool:  
