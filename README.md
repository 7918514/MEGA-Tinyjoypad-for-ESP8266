...
![Фото](pics/pcb.jpg)![Фото](pics/pcb-2.jpg)  
...
![Фото](pics/connector-1.jpg)![Фото](pics/connector-2.jpg)![Фото](pics/connector-3.jpg)  
...
Если Вы после сборки сразу хотите загрузить прошивку, не разбираясь с Arduino IDE, то загрузите в устройство готовую прошивку **MEGAcompilation160mhz_v0027.bin** программой Flash Download Tool.  
...
5. В программе Flash Download Tool выберите COM порт, который Windows присвоил устройству после его включения (можно посмотреть в диспетчере устройств Windows).  
   ...
   Укажите в программе путь до файла MEGAcompilation160mhz_v0027.bin  
...
В строке поиска наберите «SSD1306», найдите блок **ESP8266 and ESP32 OLED driver for SSD1306 displays by Thing Pulse**
  ...
  - Выберите версию библиотеки 4.6.2 (с другими версиями не пробовал).  
  - Нажмите кнопку «Установка», дождитесь завершения установки.  
...
В проводнике откройте папку с проектом, перейдите в папку **firmware** и далее в папку **MEGAcompilation160mhz_v0027**  
Дважды щелкните на файле «MEGAcompilation160mhz_v0027.ino»  
...
P.S. В папке **firmware/test** есть парочка прошивок не относящихся к проекту. Пробуйте, изобретайте!
