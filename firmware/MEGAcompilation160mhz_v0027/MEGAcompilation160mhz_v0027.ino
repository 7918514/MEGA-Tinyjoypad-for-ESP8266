//    >>>>>  MEGA COMPILATION 0027 for ESP8266/ESP8285  GPL v3 <<<<
//                    >>>>>  MEGA Tinyjoypad  <<<<
//                   Programmer: Daniel C 2019-2026
...
//  20-Gilbert in the Downland (Electro L.I.B) (2025)
//  21-Tiny-Doc (Electro L.I.B) (2025)
//  22-Tiny Arena (Électro L.I.B) -> NEW (2026)
...
// Optionnel : pour être encore plus agressif
...
void disableWatchdog() {
  ...
  ESP.wdtDisable(); // Désactiver le WDT logiciel
  *((volatile uint32_t*)0x60000900) &= ~(1); // Désactiver le WDT matériel
